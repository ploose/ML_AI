# Code based on the works of the "Unsupervised Learning, Recommenders, Reinforcement Learning" course by DeepLearning.AI & Stanford University
# For more information, visit: https://www.coursera.org/learn/unsupervised-learning-recommenders-reinforcement-learning
...
def get_action(q_values, range, epsilon=0 ):
    if random.random() > epsilon:
        return np.argmax(q_values.numpy()[0])
    else:
        return random.choice(np.arange(range))
